...
export const catalogSlice = createSlice({
    ...
    initialState: productsAdapter.getInitialState<CatalogState>({
        ...
        brands:[],
        types: [],
        productParams: initParams(),   //initial state vermem gerekiyor..state bos olamaz!
        metaData: null
    }),
    reducers: {
...
export const {setProductParams, setMetaData, setPageNumber, resetProdcutParams} = catalogSlice.actions;  // redux tool kit   reducerlar icine  actionlari da gomdu